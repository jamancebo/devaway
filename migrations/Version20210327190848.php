 ...
 */
final class Version20210327190848 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE races DROP points, CHANGE id id VARCHAR(255) NOT NULL, CHANGE id_pilot id_pilot VARCHAR(255) NOT NULL, CHANGE name name VARCHAR(255) NOT NULL, CHANGE time time VARCHAR(255) NOT NULL, CHANGE best_time best_time VARCHAR(255) NOT NULL');
    }
