 ...
 */
final class Version20210326235801 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE pilots ADD points INT NOT NULL, CHANGE id id VARCHAR(255) NOT NULL, CHANGE photo photo VARCHAR(255) NOT NULL, CHANGE team team VARCHAR(255) NOT NULL, CHANGE name name VARCHAR(255) NOT NULL, CHANGE age age INT NOT NULL');
