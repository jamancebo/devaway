 ...
 */
final class Version20210330181830 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE races ADD total_time VARCHAR(255) NOT NULL, CHANGE id id VARCHAR(255) NOT NULL, CHANGE id_pilot id_pilot VARCHAR(255) NOT NULL, CHANGE name name VARCHAR(255) NOT NULL, CHANGE best_time best_time VARCHAR(255) NOT NULL, CHANGE points points INT NOT NULL');
    }
